...
export const updateCertificate = async (id, data) => {
  const response = await apiClient.put(`/api/certificates/${id}`, data);
  return response.data;
};
...
export const toggleCertificateFeatured = async (id) => {
  const response = await apiClient.put(`/api/certificates/${id}/toggle-featured`);
  return response.data;
};

export const bulkDeleteCertificates = async (certificateIds) => {
  const response = await apiClient.delete('/api/certificates/bulk', {
    data: { certificateIds },
  });
  return response.data;
};
